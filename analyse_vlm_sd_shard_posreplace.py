...
from diffusion.lvm_diffusion import StableDiffusionLVMPipelineUpgradedPosReplace
...
def main():
    ...
    pipe = StableDiffusionLVMPipelineUpgradedPosReplace.from_pretrained("CompVis/stable-diffusion-v1-4", cache_dir=cache_hub_folder, device_map="balanced")
