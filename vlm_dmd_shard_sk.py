...
def main():
    ...
    for i in range(iterations):
        ...
        samples = pipe(prompt=prompts, num_inference_steps=4 ,guidance_scale=0.0, timesteps=[999, 749, 499, 249], skip=args.skip,
                        lvm_tokenizer=tokenizer, lvm_model=model, lvm_image_processor=image_processor,  
                        do_lvm_guidance=args.lvm_guidance, process_prompt_mode=process_prompt_mode).images
