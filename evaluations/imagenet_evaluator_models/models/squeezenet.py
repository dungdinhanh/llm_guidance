...
def squeezenet1_0(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(load_state_dict_from_url(model_urls['squeezenet1_0'], progress=True, model_dir=models_dir))
    return model
...
def squeezenet1_1(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(load_state_dict_from_url(model_urls['squeezenet1_1'], progress=True, model_dir=models_dir))
    return model