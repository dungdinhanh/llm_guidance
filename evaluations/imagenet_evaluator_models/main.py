...
from evaluations.imagenet_evaluator_models.models import *
from evaluations.imagenet_evaluator_models.data_loader import data_loader
...
def main(local_rank):
    ...
    # Data loading
    mini = args.local
    train_loader, val_loader = data_loader(args.batch_size, args.workers, args.pin_memory, mini, args.img_size)
