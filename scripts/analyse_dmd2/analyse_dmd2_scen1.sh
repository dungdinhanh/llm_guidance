...
#  done
 ...
 for seed in "${seeds[@]}"
do
 cmd="HUGGINGFACE_HUB_CACHE=${hub_folder} HFAI_DATASETS_DIR=/hdd/datasets/ python analyse_vlm_dmd2_shard.py --sample-dir runs/dmd2_analyse_failurecases_simple1/seed${seed}/largelvm_dmd2_nolvm/ \
