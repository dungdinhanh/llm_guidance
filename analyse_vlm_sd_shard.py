...
from diffusion.lvm_diffusion import StableDiffusionLVMPipelineUpgraded
...
def main():
    ...
    pipe = StableDiffusionLVMPipelineUpgraded.from_pretrained("CompVis/stable-diffusion-v1-4", cache_dir=cache_hub_folder, device_map="balanced")
    ...
    for i in range(iterations):
        ...
        samples = pipe(prompt=prompts, guidance_scale=args.cfg_scale, skip=args.skip, lvm_tokenizer=tokenizer, lvm_model=model, 
                       ...
                       track_image_prompt=True, analysis_folder=analysis_folder_dir).images
